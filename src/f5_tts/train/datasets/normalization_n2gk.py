...
class N2gk:
    ...
    def convert_english_number(self, text: str) -> str:
        ...
        def replacer(match):
            ...
            if 0 <= number_part <= 10:
                ...
                number_in_korean = str(number_part)  
    ...
    def to_hanja(self, num, natural=True) -> str:
        ...
        if isinstance(num, float):
            ...
            frac_kor = ''.join(
                self.NUM_KOR[int(ch)] if ch != '0' else '영'    
...
# Singleton for use across the project
_n2gk_plus_instance = None


def normalize_n2gk_plus(text: str, natural: bool = True) -> str:
    """Apply N2gk+ normalization (CoreaSpeech). Single sentence."""
    global _n2gk_plus_instance
    if _n2gk_plus_instance is None:
        _n2gk_plus_instance = N2gkPlus(natural=natural)
    return _n2gk_plus_instance(text)
