"""
Prepare dataset with pipeline: N2gk+ -> 자모 분리 (Grapheme).
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="N2gk+ -> grapheme (jamo). Output: raw.arrow, duration.json, vocab.txt."
    )
    parser.add_argument("--name", type=str, default="KSS_n2gk_grapheme", help="Output dataset name.")
